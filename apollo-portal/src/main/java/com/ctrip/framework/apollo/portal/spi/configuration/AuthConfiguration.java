...
public class AuthConfiguration {
  ...
  static class SpringSecurityAuthAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingProfile("dm")
  ...
  /**
   * Dameng (DM8) uses double-quoted identifiers; MySQL-style backticks in login queries would fail.
   * When profile "dm" is active, use this JdbcUserDetailsManager with double-quoted table/column names.
   */
  @Configuration
  @Profile("auth & dm")
  static class DamengSpringSecurityAuthAutoConfiguration {
