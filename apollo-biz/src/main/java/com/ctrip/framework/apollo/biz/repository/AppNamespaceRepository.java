...
public interface AppNamespaceRepository extends PagingAndSortingRepository<AppNamespace, Long>{
  ...
  @Modifying
  @Query("UPDATE AppNamespace SET IsDeleted = 1, DeletedAt = -Id, DataChange_LastModifiedBy = ?2 WHERE AppId=?1 and IsDeleted = 0")
  int batchDeleteByAppId(String appId, String operator);

  @Modifying
  @Query("UPDATE AppNamespace SET IsDeleted = 1, DeletedAt = -Id, DataChange_LastModifiedBy = ?3 WHERE AppId=?1 and Name = ?2 and IsDeleted = 0")
